        ...
        <section class="contact_form_area p_100">
        	<div class="container">
        		<div class="main_title">
					<h2>Kontak Kami</h2>
					<h5>Apakah Anda memiliki sesuatu dalam pikiran Anda untuk memberitahu kami tahu?  Mohon Jangan menunda untuk menghubungkan kepada kami dengan cara formulir kontak kami.</h5>
				</div>
       			<div class="row">
       				<div class="col-lg-7">
       					<form class="row contact_us_form" action="http://galaxyanalytics.net/demos/cake/theme/cake-html/contact_process.php" method="post" id="contactForm" novalidate="novalidate">
							...
							<div class="form-group col-md-12">
								<textarea class="form-control" name="message" id="message" rows="1" placeholder="Tuliskan"></textarea>
							</div>
							<div class="form-group col-md-12">
       				...
       				<div class="col-lg-4 offset-md-1">
       					<div class="contact_details">
       						<div class="contact_d_item">
       							<h3>Address :</h3>
       							<p>Jl. Katapang Soreang,Kabupaten Bandung</p>
       						</div>
       						<div class="contact_d_item">
       							<h5>Phone : <a href="tel:085624750108">085624750108</a></h5>
       							<h5>Email : <a href="PastryKU@gmail.com">PastryKU@gmail.com</a></h5>
       						</div>
       						<div class="contact_d_item">
       							<h3>Buka Jam :</h3>
